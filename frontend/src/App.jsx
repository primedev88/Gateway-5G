      ...
      <div className='main_screen'>
        ...
        <div className="wifi-nodes">
          ...
          < div className="nodes-divider">
              <Node bgColor={(wifi.devices[0].status=='unconnected')? '#DAEDFF':'#8BFF6D'}/>
              <Node bgColor={(wifi.devices[1].status=='unconnected')? '#DAEDFF':'#8BFF6D'}/>
              <Node bgColor={(wifi.devices[2].status=='unconnected')? '#DAEDFF':'#8BFF6D'}/>
              <Node bgColor={(wifi.devices[3].status=='unconnected')? '#DAEDFF':'#8BFF6D'}/>
              <Node bgColor={(wifi.devices[4].status=='unconnected')? '#DAEDFF':'#8BFF6D'}/>
              <Node bgColor={(wifi.devices[5].status=='unconnected')? '#DAEDFF':'#8BFF6D'}/>
              <Node bgColor={(wifi.devices[6].status=='unconnected')? '#DAEDFF':'#8BFF6D'}/>
              <Node bgColor={(wifi.devices[7].status=='unconnected')? '#DAEDFF':'#8BFF6D'}/>
        ...
        <div className="lora-nodes">
          ...
          <div className="nodes-divider">
              <LoraNode bgColor={(lora.devices[0].status=='unconnected')? '#DAEDFF':'#8BFF6D'}/>
              <LoraNode bgColor={(lora.devices[1].status=='unconnected')? '#DAEDFF':'#8BFF6D'}/>
              <LoraNode bgColor={(lora.devices[2].status=='unconnected')? '#DAEDFF':'#8BFF6D'}/>
              <LoraNode bgColor={(lora.devices[3].status=='unconnected')? '#DAEDFF':'#8BFF6D'}/>
              <LoraNode bgColor={(lora.devices[4].status=='unconnected')? '#DAEDFF':'#8BFF6D'}/>
              <LoraNode bgColor={(lora.devices[5].status=='unconnected')? '#DAEDFF':'#8BFF6D'}/>
              <LoraNode bgColor={(lora.devices[6].status=='unconnected')? '#DAEDFF':'#8BFF6D'}/>
              <LoraNode bgColor={(lora.devices[7].status=='unconnected')? '#DAEDFF':'#8BFF6D'}/>
          </div>
        </div>
        </div>
      </div>
      {
        isModalOpen && <Credential closeModal={closeModal} handleSubmit={handleFormSubmit}/>
      }
    </>
  )
}
